...
export const Register = ({
  ...
  return (
    ...
    >
      <button
        onClick={onBack}
        className="self-start p-2 -ml-2 text-slate-400 hover:text-slate-600"
      >
        <ArrowLeft size={24} />
      </button>
      ...
      <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full py-8">
        ...
        >
          ...
          {isStudent ? (
            <div className="space-y-2">
              ...
              <p className="text-xs text-slate-400">
                Necessário apenas para agendar aulas.
              </p>
            </div>
          ) : (
            <>
          ...
          <Button className="w-full py-4 text-lg mt-6" disabled={loading}>
            {loading ? (
