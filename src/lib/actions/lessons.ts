...
function mapLesson(lesson: any): LessonType {
  return {
    ...
    checkInTime: lesson.checkInTime ? parseBRDate(lesson.checkInTime) ?? new Date(lesson.checkInTime) : undefined,
    checkOutTime: lesson.checkOutTime ? parseBRDate(lesson.checkOutTime) ?? new Date(lesson.checkOutTime) : undefined,
