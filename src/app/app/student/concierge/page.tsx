...
const JOURNEY_GUIDE: GuideEntry[] = [
  ...
  {
    step: 3,
    title: "Exames médico, psicológico e toxicológico",
    description: "O DETRAN indica a clínica credenciada. Leve RG e CPF. Toxicológico obrigatório para categorias A e B (Lei 15.153/2025).",
    cost: "R$ 200–350",
  ...
  },
  {
    step: 5,
    title: "LADV",
    description: "Emitida via app CNH do Brasil após aprovação. Válida por 12 meses.",
    cost: "Gratuita",
