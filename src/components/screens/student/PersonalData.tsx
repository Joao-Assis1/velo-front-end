...
import { User, Mail, Phone, Fingerprint, Camera, Check, ArrowLeft } from 'lucide-react';
    ...
    <div className="pb-24 pt-6 px-4 space-y-6">
      <header className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-slate-500 text-sm">Mantenha seu perfil atualizado</p>
        </div>
      </header>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-bold text-slate-700 ml-1">Celular / WhatsApp</label>
            <Input 
              type="tel"
          ...
          <div className="space-y-1.5">
            ...
            <Input 
              ...
              onChange={(e) => setLocalProfile({ ...localProfile, cpf: e.target.value })}
        ...
        <Button className="w-full py-4 text-lg" disabled={isSaved}>
          {isSaved ? <><Check size={20} /> Salvo com Sucesso</> : 'Salvar Alterações'}
        </Button>
      </form>
    </div>
  );
